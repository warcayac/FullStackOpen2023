...
import { TChangeInputFunction, TFormSubmitFunction, TNote, TNoteList } from "./utils/types";
...
export default function App() {
  ...
  */
  ...
  const addNote: TFormSubmitFunction = (event) => {
  ...
  const handleNoteChange: TChangeInputFunction = (event) => setNewNote(event.target.value);
